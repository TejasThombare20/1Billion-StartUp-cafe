 ...
 const dispatch = useDispatch( )
  ...
  return (
    <motion.div
      ...
      className={
        "w-full flex flex-col items-start justify-start px-3 py-2 border relative border-gray-300  bg-lightOverlay drop-shadow-md rounded-md gap-4"
      }
    >
      <div className="w-full flex items-center justify-between ">
        ...
        <div className="flex items-center gap-4 ">
          ...
          <p
            className={`text-base font-semibold capitalize border bg-gray-300 px-2 py-[2px] rounded-md ${
              (data.sts === "preparing" && "text-orange-500 bg-orange-100") ||
              (data.sts === "cancelled" && "text-red-500 bg-red-100") ||
              (data.sts === "delivered" && "text-emrald-500 bg-emerald-100")
            }`}
          >
            {data?.sts}
          </p>
          ...
          {admin && (
            <div className="flex items-center justify-center gap-2">
              <p className="text-lg font-semibold As</p> text-headingColor">
                Mark as
              </p>
              ...
              <motion.p
                ...
                className={
                  "text-orange-500 text-base font-semibold capitalize border border-gray-300 px-2 py-[2px] rounded-md cursor-pointer"
                }
              >
                Preparing
              </motion.p>
              <motion.p
                ...
                onClick={() => handleClick(data.orderId, "preparing")}
                className={
                  "text-red-500 text-base font-semibold capitalize border border-gray-300 px-2 py-[2px] rounded-md cursor-pointer"
                }
              >
                Cancelled
              </motion.p>
              <motion.p
                ...
                onClick={() => handleClick(data.orderId, "preparing")}
                className={
                  "text-emerald-500 text-base font-semibold capitalize border border-gray-300 px-2 py-[2px] rounded-md cursor-pointer"
                }
              >
                Delivered
              </motion.p>
      ...
      <div className="flex items-center justify-start flex-wrap w-full ">
        ...
        <div className="flex items-start justify-start flex-col gap-2 px-6 ml-auto w-full md:w-400 ">
